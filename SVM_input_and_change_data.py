...
X = pd.DataFrame(X_imputed, columns=X.columns.astype(str))  # 确保列名是字符串类型
...
'''
Mean Squared Error: 877.5768873683029
R² Score: -0.025876151665508385
SVM输麻了，但推测应该不是SVM的问题，而是我填补数据太抽象了，用平均值填数据，直接寄了
'''